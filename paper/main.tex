...
can expect from an average student. Similar algorithm in various
languages. Use as few external libraries as possible, but use them if
needed.
...
vectors, since they are necessary in most algorithms for 
